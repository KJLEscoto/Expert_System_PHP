...
<div
  ...
  <div class="md:w-1/2 w-full md:p-10 p-0">
    <h1 class="text-center text-2xl font-bold text-[#003568] dark:text-[#414455] cursor-default mb-5">Message Us!</h1>
...
<div class="grid lg:grid-cols-2 grid-cols-1 mt-32">
  ...
  <div class="flex lg:px-5 px-0">
    ...
    <button
      class="m-auto px-3 py-2 hover:bg-[#febd5b] bg-[#5495C9] font-semibold text-white border-[#2e5679] border-2 hover:border-[#dba047] hover:text-[#002951] transition duration-300 ease-in-out rounded-r-md dark:hidden block "
      type="button">Send</button>
    <button
      class="m-auto px-3 py-2 bg-[#febd5b] hover:bg-[#5495C9] font-semibold hover:text-white hover:border-[#2e5679] border-2 border-[#dba047] text-[#002951] transition duration-300 ease-in-out rounded-r-md dark:block hidden"
      type="button">Send</button>
  </div>
</div>