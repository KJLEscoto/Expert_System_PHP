<nav id="navbar" class="py-5 md:px-20 px-10 duration-300 fixed top-0 left-0 w-full z-10">
  <header class="mx-auto flex items-center justify-between duration-300">
    <section class="">
      <div class="flex items-center">
        <a href=".././php_tabs/index.php"><img
            class="w-auto h-[40px] mr-2 hover:scale-95 transition duration-300 ease-in-out" src=".././img/sti.png"
            alt="STI-Logo"></a>
        <h1 class="text-xl font-bold text-[#005BAB] cursor-default transition duration-300 ease-in-out tracking-wider">
          <?php echo "College - Davao"; ?></h1>
      </div>
    </section>
    ...
    <section class="lg:block hidden">
      <button
        class="border-[#dba047] border-2 py-2 px-10 shadow-md tracking-wider rounded-2xl bg-[#FCB244] hover:bg-[#5495C9] font-semibold hover:text-white text-[#005BAB] transition duration-300 ease-in-out">
        Take Test!
      </button>
    </section>
