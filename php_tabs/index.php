...
<body class="bg-[#e4e4e4]">
  ...
  <section class="md:px-36 px-10 duration-300 z-0 grid lg:grid-cols-2 grid-cols-1 gap-9 border">
  ...
  <section class="md:px-36 px-10 duration-300 z-0 mt-20 border tracking-wide">
    <h1 class="text-3xl font-extrabold text-[#003568] cursor-default">Welcome to the "Exploring Emotional Well-Being"
    </h1>
    <p class="text-[#004e94] text-lg mt-3">We are excited to have you participate in this important study focused on
      understanding
      emotions and
      emotional
      well-being.
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 lg:grid-cols-4 mt-14">
  ...
  <hr class="border border-b-slate-400 mt-32 mb-5">
